            ...
            <Row class="ecxh-tablerank">
                ...
                <Row>
                    <template v-if="loadingTab">
                        <Col span="24">
                        <Table class="fd-detail-tabrank" border stripe :columns="tabColumns" :data="tabDatas">
                            <!--<tr style="display: flex" slot="header">-->
                                <!--<th class="ivu-table-cell" style="width: 81px"></th>-->
                                <!--<th class="ivu-table-cell" style="flex: 1;border-right:none">持买单</th>-->
                                <!--<th style="width: 4px;border-right:1px solid #e9eaec"></th>-->
                                <!--<th class="ivu-table-cell" style="flex: 1;border-right:none">持卖单</th>-->
                                <!--<th style="width: 4px;border-right:1px solid #e9eaec"></th>-->
                                <!--<th class="ivu-table-cell" style="flex: 1;border-right:none">持买单</th>-->
                                <!--<th style="width: 2px;border-right:1px solid #e9eaec"></th>-->
                                <!--<th class="ivu-table-cell" style="flex: 1;border-right:none">持卖单</th>-->
                                <!--<th style="width: 1px;border-right:1px solid #e9eaec"></th>-->
                                <!--<th class="ivu-table-cell" style="flex: 1;border-right:none">持买单</th>-->
                                <!--<th style="width: 1px;border-right:1px solid #e9eaec"></th>-->
                                <!--<th class="ivu-table-cell" style="flex: 1;border-right:none">持卖单</th>-->
                                <!--<th style="width: 1px;border-right:1px solid #e9eaec"></th>-->
                            ...
                            <!--<div style="width: 100%;display: flex">-->
                                <!--<div style="width: 100px;display: inline-block">11111</div>-->
                                <!--<div style="width: 100px;display: flex;flex: 1">-->
                                    <!--<div style="flex: 1;display: flex">-->
                                        <!--<div class="header-text">买单</div>-->
                                        <!--<div class="header-text">卖单</div>-->
                                    <!--</div>-->
                                    <!--<div style="flex: 1;display: flex">-->
                                        <!--<div class="header-text">买单</div>-->
                                        <!--<div class="header-text">卖单</div>-->
...
//                var delivUrl = getExchODataApi(`FutureHoldData?$select=DelivDate&$filter=(VariCode eq '${variCode}' and CustName eq '${custName}' and Date ge ${startDate} and Date le ${endDate} and (PurNum ne 0 or PurNum_CHG ne 0 or SellNum ne 0 or SellNum_CHG ne 0))&$orderby=DelivDate`)
                let sellUrl = getExchODataApi(`FutureHoldDataReport/?$filter=(VariCode eq '${variCode}' and Count eq ${_self.$route.query.Count} and Date ge ${startDate} and Date le ${endDate} and DelivDate ne 'all')&$orderby=DelivDate&$format=json&$select=DelivDate`)
                o(sellUrl).get().then(
                    (response) => {
...
//                var delivUrl = getExchODataApi(`FutureHoldData?$select=Date&$filter=(VariCode eq '${variCode}' and CustName eq '${custName}' and Date ge ${startDate} and Date le ${endDate} and (PurNum ne 0 or PurNum_CHG ne 0 or SellNum ne 0 or SellNum_CHG ne 0))&$orderby=Date`)
                let sellUrl = getExchODataApi(`FutureHoldDataReport/?$filter=(VariCode eq '${variCode}' and Count eq ${_self.$route.query.Count} and Date ge ${startDate} and Date le ${endDate})&$orderby=Date&&$select=Date`)
                o(sellUrl).get().then(
                    (response) => {
                        var data = response.data
                        var dateArr = []
            ...
            getAllTabData: function () {
                ...
                if (this.startDate && this.endDate) {
                    ...
                    if (startDate && endDate) {
                        if (deliv1) {
                            this.getTableDatax(0, this.deliv1)
                        }
                        if (deliv2) {
                            this.getTableDatax(1, this.deliv2)
                        }
                        if (deliv3) {
                            this.getTableDatax(2, this.deliv3)
                        }
                        this.getTableDatax(3, 'all')
                    }
//                    if (x === 0) {
//                        _this.setChartData(tableData, _this.chartOption1_1, _this.chartOption1_2, _this.chartOption1_3)
//                    }
//                    if (x === 1) {
//                        _this.setChartData(tableData, _this.chartOption2_1, _this.chartOption2_2, _this.chartOption2_3)
//                    }
//                    if (x === 2) {
//                        _this.setChartData(tableData, _this.chartOption3_1, _this.chartOption3_2, _this.chartOption3_3)
//                    }
//                    if (x === 3) {
//                        _this.setChartData(tableData, _this.chartOption4_1, _this.chartOption4_2, _this.chartOption4_3)
//                    }
                }
                this.initVal = false
//                this.loadingTab = true
            ...
            setTabDatax (tabData) {
                ...
                dateArr.forEach(function (item) {
                    ...
                    obj.Date = item.substr(0, 10)
                    if (tabData[0]) {
                        tabData[0].forEach(function (tableitem) {
                            if (tableitem.Date === item) {
                                obj.PurNumCount = tableitem.PurNumCount
                                obj.PurNum_Pur = tableitem.PurNum_Pur
                                obj.PurNum_Sell = tableitem.PurNum_Sell
                                obj.SellNumCount = tableitem.SellNumCount
                                obj.SellNum_Pur = tableitem.SellNum_Pur
                                obj.SellNum_Sell = tableitem.SellNum_Sell
                                obj.cellClassName.PurNum_Pur = tableitem.PurNum_Pur >= 0 ? 'cell-red' : 'cell-green'
                                obj.cellClassName.PurNum_Sell = tableitem.PurNum_Sell >= 0 ? 'cell-red' : 'cell-green'
                                obj.cellClassName.SellNum_Pur = tableitem.SellNum_Pur >= 0 ? 'cell-red' : 'cell-green'
                                obj.cellClassName.SellNum_Sell = tableitem.SellNum_Sell >= 0 ? 'cell-red' : 'cell-green'
                            }
                        })
                    } else {
                        tabData[0] = []
                    ...
                    if (tabData[1]) {
                        tabData[1].forEach(function (tableitem) {
                            if (tableitem.Date === item) {
                                obj.PurNumCount2 = tableitem.PurNumCount
                                obj.PurNum_Pur2 = tableitem.PurNum_Pur
                                obj.PurNum_Sell2 = tableitem.PurNum_Sell
                                obj.SellNumCount2 = tableitem.SellNumCount
                                obj.SellNum_Pur2 = tableitem.SellNum_Pur
                                obj.SellNum_Sell2 = tableitem.SellNum_Sell
                                obj.cellClassName.PurNum_Pur2 = tableitem.PurNum_Pur >= 0 ? 'cell-red' : 'cell-green'
                                obj.cellClassName.PurNum_Sell2 = tableitem.PurNum_Sell >= 0 ? 'cell-red' : 'cell-green'
                                obj.cellClassName.SellNum_Pur2 = tableitem.SellNum_Pur >= 0 ? 'cell-red' : 'cell-green'
                                obj.cellClassName.SellNum_Sell2 = tableitem.SellNum_Sell >= 0 ? 'cell-red' : 'cell-green'
                            }
                        })
                    } else {
                        tabData[1] = []
                    ...
                    if (tabData[2]) {
                        tabData[2].forEach(function (tableitem) {
                            if (tableitem.Date === item) {
                                obj.PurNumCount3 = tableitem.PurNumCount
                                obj.PurNum_Pur3 = tableitem.PurNum_Pur
                                obj.PurNum_Sell3 = tableitem.PurNum_Sell
                                obj.SellNumCount3 = tableitem.SellNumCount
                                obj.SellNum_Pur3 = tableitem.SellNum_Pur
                                obj.SellNum_Sell3 = tableitem.SellNum_Sell
                                obj.cellClassName.PurNum_Pur3 = tableitem.PurNum_Pur >= 0 ? 'cell-red' : 'cell-green'
                                obj.cellClassName.PurNum_Sell3 = tableitem.PurNum_Sell >= 0 ? 'cell-red' : 'cell-green'
                                obj.cellClassName.SellNum_Pur3 = tableitem.SellNum_Pur >= 0 ? 'cell-red' : 'cell-green'
                                obj.cellClassName.SellNum_Sell3 = tableitem.SellNum_Sell >= 0 ? 'cell-red' : 'cell-green'
                            }
                        })
                    } else {
                        tabData[2] = []
                    ...
                    if (tabData[3]) {
                        tabData[3].forEach(function (tableitem) {
                            if (tableitem.Date === item) {
                                obj.PurNumCount4 = tableitem.PurNumCount
                                obj.PurNum_Pur4 = tableitem.PurNum_Pur
                                obj.PurNum_Sell4 = tableitem.PurNum_Sell
                                obj.SellNumCount4 = tableitem.SellNumCount
                                obj.SellNum_Pur4 = tableitem.SellNum_Pur
                                obj.SellNum_Sell4 = tableitem.SellNum_Sell
                                obj.cellClassName.PurNum_Pur4 = tableitem.PurNum_Pur >= 0 ? 'cell-red' : 'cell-green'
                                obj.cellClassName.PurNum_Sell4 = tableitem.PurNum_Sell >= 0 ? 'cell-red' : 'cell-green'
                                obj.cellClassName.SellNum_Pur4 = tableitem.SellNum_Pur >= 0 ? 'cell-red' : 'cell-green'
                                obj.cellClassName.SellNum_Sell4 = tableitem.SellNum_Sell >= 0 ? 'cell-red' : 'cell-green'
                            }
                        })
                    } else {
                        tabData[3] = []
            ...
            setChartData: function (tableData, chartOption1, chartOption2, chartOption3) {
                ...
                for (let i = 0; i < tableData.length; i++) {
                    if (tableData[i].PurNumCount === 0) {
                        data1.push('')
                    } else {
                        data1.push(tableData[i].PurNumCount)
                    }
                    if (tableData[i].SellNumCount === 0) {
                        data2.push('')
                    } else {
                        data2.push(tableData[i].SellNumCount)
                    }
                    if (tableData[i].PurNum_Pur === 0) {
                        pData1.push('')
                    } else {
                        pData1.push(tableData[i].PurNum_Pur)
                    }
                    if (tableData[i].PurNum_Sell === 0) {
                        pData2.push('')
                    } else {
                        pData2.push(tableData[i].PurNum_Sell)
                    }
                    if (tableData[i].SellNum_Pur === 0) {
                        sData1.push('')
                    } else {
                        sData1.push(tableData[i].SellNum_Pur)
                    }
                    if (tableData[i].SellNum_Sell === 0) {
                        sData2.push('')
                    } else {
                        sData2.push(tableData[i].SellNum_Sell)
                    }
                    if (tableData[i].Date) {
                ...
                chartOption2.series[0].data = pData1
                chartOption2.series[1].data = pData2
                chartOption3.xAxis.data = xAxisData
                chartOption3.series[0].data = sData1
                chartOption3.series[1].data = sData2
//                chartOption3.xAxis.data = xAxisData
//                chartOption3.series[0].data = sData
            ...
            getTableDatax: function (x, deliv2) {
                let _self = this
                let _this = this
                let purUrl = ''
                let sellUrl = ''
                ...
                let sellUrlDown = ''
                let timeUrl = ''
                var deliv = this.getDelivDate(deliv2)
                var variCode = this.variCode
                var startDate = this.startDate
                var endDate = this.endDate
                if (startDate && endDate && deliv2) {
                    if (this.enabledDate.length > 0) {
                        ...
                        startDate = dateArr[0]
                        endDate = dateArr[1]
                        timeUrl = getExchODataApi(`FutureHoldDataReport/?$filter=((VariCode eq '${variCode}') and contains(DelivDate, '${deliv}') and Date ge ${startDate} and Date le ${endDate} and Count eq ${_self.$route.query.Count})&$orderby=Date asc`)
                        purUrl = getExchODataApi(`FutureHoldDataReport/?$filter=((VariCode eq '${variCode}') and contains(DelivDate, '${deliv}') and Date ge ${startDate} and Date le ${endDate} and Count eq ${_self.$route.query.Count} and Type eq 'PurNum')&$orderby=Date asc`)
                        sellUrl = getExchODataApi(`FutureHoldDataReport/?$filter=((VariCode eq '${variCode}') and contains(DelivDate, '${deliv}') and Date ge ${startDate} and Date le ${endDate} and Count eq ${_self.$route.query.Count} and Type eq 'SellNum')&$orderby=Date asc`)
                        purUrlUp = getExchODataApi(`FutureHoldDataReport/?$filter=((VariCode eq '${variCode}') and contains(DelivDate, '${deliv}') and Date ge ${startDate} and Date le ${endDate} and Count eq ${_self.$route.query.Count} and Type eq 'PurNum_Up')&$orderby=Date asc`)
                        purUrlDown = getExchODataApi(`FutureHoldDataReport/?$filter=((VariCode eq '${variCode}') and contains(DelivDate, '${deliv}') and Date ge ${startDate} and Date le ${endDate} and Count eq ${_self.$route.query.Count} and Type eq 'PurNum_Down')&$orderby=Date asc`)
                        sellUrlUp = getExchODataApi(`FutureHoldDataReport/?$filter=((VariCode eq '${variCode}') and contains(DelivDate, '${deliv}') and Date ge ${startDate} and Date le ${endDate} and Count eq ${_self.$route.query.Count} and Type eq 'SellNum_Up')&$orderby=Date asc`)
                        sellUrlDown = getExchODataApi(`FutureHoldDataReport/?$filter=((VariCode eq '${variCode}') and contains(DelivDate, '${deliv}') and Date ge ${startDate} and Date le ${endDate} and Count eq ${_self.$route.query.Count} and Type eq 'SellNum_Down')&$orderby=Date asc`)
                    } else {
                        purUrl = ''
                        sellUrl = ''
                        purUrlUp = ''
                ...
                if (purUrl) {
                    Q.all([
                        _self.getOdata(purUrl),
                        _self.getOdata(sellUrl),
                        _self.getOdata(purUrlUp),
                        _self.getOdata(purUrlDown),
                        _self.getOdata(sellUrlUp),
                        _self.getOdata(sellUrlDown),
                        _self.getOdata(timeUrl)
                    ]).then(function (oHandlerArray) {
                        let tabData = oHandlerArray[6].data
                        let dateArr = []
                        for (let i = 0; i < tabData.length; i++) {
                            dateArr.push(tabData[i].Date)
                        }
                        dateArr = Array.from(new Set(dateArr))
                        dateArr.sort()
                        dateArr.forEach(function (timeItem) {
                            let tableitem = {
                                Date: null,
                                PurNumCount: 0,
                                PurNum_Pur: 0,
                            ...
                            tableitem.Date = timeItem
                            oHandlerArray[0].data.forEach(function (item) {
                                if (timeItem === item.Date) {
                                    tableitem.PurNumCount = item.PurNum
                                }
                            })
                            oHandlerArray[1].data.forEach(function (item) {
                                if (timeItem === item.Date) {
                                    tableitem.SellNumCount = item.SellNum
                                }
                            })
                            oHandlerArray[2].data.forEach(function (item) {
                                if (timeItem === item.Date) {
                                    tableitem.PurNum_Pur = item.PurNum_CHG
                                }
                            })
                            oHandlerArray[3].data.forEach(function (item) {
                                if (timeItem === item.Date) {
                                    tableitem.PurNum_Sell = item.PurNum_CHG
                                }
                            })
                            oHandlerArray[4].data.forEach(function (item) {
                                if (timeItem === item.Date) {
                                    tableitem.SellNum_Pur = item.SellNum_CHG
                                }
                            })
                            oHandlerArray[5].data.forEach(function (item) {
                                if (timeItem === item.Date) {
                                    tableitem.SellNum_Sell = item.SellNum_CHG
                                }
                            })
                            tableData.push(tableitem)
                        })
                        _this.tabData[x] = tableData
                        _this.setTabDatax(_this.tabData)
                        if (x === 0) {
                            _this.setChartData(tableData, _this.chartOption1_1, _this.chartOption1_2, _this.chartOption1_3)
                        }
                        if (x === 1) {
            ...
            changeVari: function (name) {
                ...
                this.$router.push({name: 'FutureHoldDataRankDetail', params: {VariCode: name, CustName: this.CustName}, query: {Count: this.Count, Type: this.Type}})
                this.tabData = [[], [], [], []]
                let tableData = [[], [], [], []]
                _this.setChartData(tableData, _this.chartOption1_1, _this.chartOption1_2, _this.chartOption1_3)
                _this.setChartData(tableData, _this.chartOption2_1, _this.chartOption2_2, _this.chartOption2_3)
            ...
            downExl () {
                ...
                if (delivArr.length === 1) {
                    delivFilter = "and(contains(DelivDate, '" + delivArr[0] + "') or contains(DelivDate, 'all'))"
                }
                if (delivArr.length === 2) {
                    delivFilter = "and(contains(DelivDate, '" + delivArr[0] + "') or contains(DelivDate, '" + delivArr[1] + "') or contains(DelivDate, 'all'))"
                }
                if (delivArr.length === 3) {
                    delivFilter = "and(contains(DelivDate, '" + delivArr[0] + "') or contains(DelivDate, '" + delivArr[1] + "') or contains(DelivDate, '" + delivArr[2] + "') or contains(DelivDate, 'all'))"
                }
                endDate = this.toDateTime(endDate)
                let downFilterUrl = `(VariCode eq '${variCode}' and Count eq ${count} and (Type eq 'PurNum' or Type eq 'SellNum') and Date ge ${startDate} and Date le ${endDate} ${delivFilter})`
                let url = getExchODataApi(`/FutureHoldDataReport/ExchData.ExportExecl?$filter=${downFilterUrl}&$orderby=Date,DelivDate`)
...
<style>
    ...
    .ecxh-tablerank .p-r-sm{
        /* margin-top: 15px; */
    }
    .ecxh-tablerank .p-r-sm:last-child{
        padding-right: 0px;
    }
    .ecxh-tablerank .ivu-table-cell{
    ...
    .table-title1 .primary{
        background: #2d8cf0;
        color: #ffffff;
    }
    .table-title1 .success{
        background: #19be6b;
        color: #ffffff;
    }
    .table-title1 .warning{
        background: #f90;
        color: #ffffff;
    }
    .table-title1 .red{
    ...
    .fd-detail-tabrank .ivu-table-body tr td:nth-child(n+1){
        width: 8.8%;
        text-align: right;
    }
    ...
    .fd-detail-tabrank .ivu-table-body tr td:nth-child(1){
        text-align: left;
    }
    ...
    .fd-detail-tabrank .ivu-table th:nth-child(1)
    {
        background: #3399CC;
        color: #ffffff;
    }
    .fd-detail-tabrank .ivu-table th:nth-child(2),
    .fd-detail-tabrank .ivu-table th:nth-child(3),
    .fd-detail-tabrank .ivu-table th:nth-child(4),
    .fd-detail-tabrank .ivu-table th:nth-child(5),
    .fd-detail-tabrank .ivu-table th:nth-child(6),
    .fd-detail-tabrank .ivu-table th:nth-child(7)
    {
        background: #60C0DD;
        color: #ffffff;
    }
    .fd-detail-tabrank .ivu-table th:nth-child(8),
    .fd-detail-tabrank .ivu-table th:nth-child(9),
    .fd-detail-tabrank .ivu-table th:nth-child(10),
    .fd-detail-tabrank .ivu-table th:nth-child(11),
    .fd-detail-tabrank .ivu-table th:nth-child(12),
    .fd-detail-tabrank .ivu-table th:nth-child(13)
    {
        background: #9BCA63;
        color: #ffffff;
    }
    .fd-detail-tabrank .ivu-table th:nth-child(14),
    .fd-detail-tabrank .ivu-table th:nth-child(15),
    .fd-detail-tabrank .ivu-table th:nth-child(16),
    .fd-detail-tabrank .ivu-table th:nth-child(17),
    .fd-detail-tabrank .ivu-table th:nth-child(18),
    .fd-detail-tabrank .ivu-table th:nth-child(19)
    {
        background: #F3A43B;
        color: #ffffff;
    }
    .fd-detail-tabrank .ivu-table th:nth-child(20),
    .fd-detail-tabrank .ivu-table th:nth-child(21),
    .fd-detail-tabrank .ivu-table th:nth-child(22),
    .fd-detail-tabrank .ivu-table th:nth-child(23),
    .fd-detail-tabrank .ivu-table th:nth-child(24),
    .fd-detail-tabrank .ivu-table th:nth-child(25)
    {
        background: #D7504B;
        color: #ffffff;
    }
